...
rule_data_list: List[Callable[[CollectionState, int], bool]] = [
    ...
    (state.has("Rubber Ball", player) and
     state.has("MQ1", player, 5)),  # Rule 23
    lambda state, player:
    state.has("Rubber Ball", player),  # Rule 24
    lambda state, player:
    state.has("Q_Saint", player),  # Rule 25
    lambda state, player:
    (state.has("Quill Pen", player) and
     state.has("MQ1", player, 4)),  # Rule 26
    lambda state, player:
    (state.has("Phantom Rose", player) and
     state.has("MQ1", player, 5)),  # Rule 27
    lambda state, player:
    (state.has("Q_BuriedPassion", player) and
     state.has("MQ1", player, 5)),  # Rule 28
    lambda state, player:
    state.has("MQ3", player, 3),  # Rule 29
    lambda state, player:
    (state.has("Gysahl Greens", player) and
     state.has("MQ3", player)),  # Rule 30
    lambda state, player:
    (state.has("Gysahl Greens", player) and
    ...
    (state.has("Data Recorder", player) and
     state.has("MQ3", player, 3)),  # Rule 34
    lambda state, player:
    (state.has("Gysahl Greens", player) and
     state.has("Q_Father", player) and
     state.has("MQ3", player)),  # Rule 35
    lambda state, player:
    state.has("Q_OldMan", player),  # Rule 36
    lambda state, player:
    (state.has("Aryas Apple", player, 2) and
     state.has("MQ3", player, 2)),  # Rule 37
    lambda state, player:
    (state.has("Gysahl Greens", player) and
...
location_rule_data_table: Dict[str, Callable[[CollectionState, int], bool]] = {
    ...
    "Luxerion - Treasured Ball Quest (1)": rule_data_list[23],
    "Luxerion - Treasured Ball Quest (2)": rule_data_list[23],
    "Luxerion - Talbot's Gratitude": rule_data_list[24],
    ...
    "Luxerion - Aremiah Service Entrance Key": rule_data_list[25],
    ...
    "Luxerion - Buried Passion Quest (1)": rule_data_list[26],
    "Luxerion - Buried Passion Quest (2)": rule_data_list[26],
    ...
    "Luxerion - A Rose By Any Other Name Quest (1)": rule_data_list[27],
    "Luxerion - A Rose By Any Other Name Quest (2)": rule_data_list[27],
    "Luxerion - A Rose By Any Other Name Quest (3)": rule_data_list[27],
    "Luxerion - A Rose By Any Other Name Quest (4)": rule_data_list[27],
    "Luxerion - Voices from the Grave Quest (1)": rule_data_list[16],
    "Luxerion - Voices from the Grave Quest (2)": rule_data_list[16],
    "Luxerion - To Save the Sinless Quest (1)": rule_data_list[28],
    "Luxerion - To Save the Sinless Quest (2)": rule_data_list[28],
    ...
    "Wildlands - Eremite Plains Broken Gyroscope Treasure": rule_data_list[29],
    "Wildlands - Aryas Village Treasure (1)": rule_data_list[0],
    "Wildlands - Jagd Woods Treasure": rule_data_list[29],
    "Wildlands - The Grasslands Treasure (1)": rule_data_list[29],
    "Wildlands - Poltae Treasure (1)": rule_data_list[29],
    "Wildlands - Canopus Farms Treasure": rule_data_list[0],
    "Wildlands - Rocky Crag Treasure (1)": rule_data_list[29],
    "Wildlands - The Grasslands Treasure (2)": rule_data_list[29],
    "Wildlands - Aryas Village Treasure (2)": rule_data_list[0],
    "Wildlands - The Grasslands Treasure (3)": rule_data_list[29],
    "Wildlands - Eremite Plains Treasure (1)": rule_data_list[29],
    "Wildlands - Eremite Plains Treasure (2)": rule_data_list[29],
    "Wildlands - Moogle Village Treasure": rule_data_list[29],
    "Wildlands - City of Ruins Treasure": rule_data_list[29],
    "Wildlands - Rocky Crag Treasure (2)": rule_data_list[29],
    "Wildlands - Rocky Crag Treasure (3)": rule_data_list[29],
    "Wildlands - Aryas Village Treasure (3)": rule_data_list[29],
    "Wildlands - Poltae Treasure (2)": rule_data_list[0],
    "Wildlands - Eremite Plains Crash Site Fragment": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (1)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (2)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (3)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (4)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (5)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (6)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (7)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (8)": rule_data_list[29],
    "Wildlands - Goddess Temple Treasure (9)": rule_data_list[29],
    "Wildlands - Dr Gysahl's Gysahl Greens": rule_data_list[0],
    "Wildlands - Aryas Village Beloved's Gift Treasure": rule_data_list[0],
    "Wildlands - Sarala Vegatable Seeds": rule_data_list[30],
    "Wildlands - A Father's Request Quest (1)": rule_data_list[30],
    "Wildlands - A Father's Request Quest (2)": rule_data_list[30],
    "Wildlands - The Hunter's Challenge Quest (1)": rule_data_list[31],
    "Wildlands - The Hunter's Challenge Quest (2)": rule_data_list[31],
    "Wildlands - The Hunter's Challenge Quest (3)": rule_data_list[31],
    ...
    "Wildlands - Saving an Angel Quest (1)": rule_data_list[30],
    "Wildlands - Saving an Angel Quest (2)": rule_data_list[30],
    "Wildlands - Omega Point Quest (1)": rule_data_list[34],
    "Wildlands - Omega Point Quest (2)": rule_data_list[34],
    "Wildlands - The Old Man and the Field Quest (1)": rule_data_list[35],
    "Wildlands - The Old Man and the Field Quest (2)": rule_data_list[35],
    "Wildlands - Land of our Forebears Quest (1)": rule_data_list[36],
    "Wildlands - Land of our Forebears Quest (2)": rule_data_list[36],
    "Wildlands - A Taste of the Past Quest (1)": rule_data_list[37],
    "Wildlands - A Taste of the Past Quest (2)": rule_data_list[37],
    "Wildlands - A Taste of the Past Quest (3)": rule_data_list[37],
    "Wildlands - Dog, Doctor and Assistant Quest (1)": rule_data_list[33],
    "Wildlands - Dog, Doctor and Assistant Quest (2)": rule_data_list[33],
    "Wildlands - Main Quest 5 (1)": rule_data_list[38],
    "Wildlands - Main Quest 5 (2)": rule_data_list[38],
    ...
    "Treasured Ball Quest Event (1)": rule_data_list[23],
    ...
    "Buried Passion Quest Event (1)": rule_data_list[26],
    ...
    "A Rose By Any Other Name Quest Event (1)": rule_data_list[27],
    "Voices from the Grave Quest Event (1)": rule_data_list[16],
    "To Save the Sinless Quest Event (1)": rule_data_list[28],
    ...
    "Omega Point Quest Event (1)": rule_data_list[34],
    "The Old Man and the Field Quest Event (1)": rule_data_list[35],
    "Land of our Forebears Quest Event (1)": rule_data_list[36],
